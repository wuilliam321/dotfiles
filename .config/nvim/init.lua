...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>cg', builtin.live_grep, { desc = '[S]earch by [G]rep' })
  ...
  { 'tyru/current-func-info.vim' },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>dm', '<cmd>call vimspector#LaunchWithSettings( #{ configuration: "method", Test: "^" . cfi#format("%s", "") . "$" } )<cr>')
    end,
  },
